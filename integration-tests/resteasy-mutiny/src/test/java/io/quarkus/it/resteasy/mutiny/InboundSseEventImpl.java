...
public class InboundSseEventImpl implements InboundSseEvent {
    ...
    static class Builder {
        ...
        public Builder write(byte[] data) {
            ...
            try {
                ...
                ex.printStackTrace();
                throw new ProcessingException("failedToWriteDataToInboudEvent: " + ex);
            }
            return this;
        }
    ...
    public <T> T readData(GenericType<T> type, MediaType mediaType) {
        ...
        if (reader == null) {
            throw new IllegalStateException("notFoundMBR " + type.getClass().getName());
        }
    ...
    private <T> T readAndCast(GenericType<T> type, MediaType effectiveMediaType, MessageBodyReader reader) {
        try {
            ...
            ex.printStackTrace();
            throw new ProcessingException("failedToReadData: " + ex);
        }
    }
