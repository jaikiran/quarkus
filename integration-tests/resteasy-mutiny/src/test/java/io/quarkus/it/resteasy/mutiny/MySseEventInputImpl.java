...
import org.jboss.resteasy.plugins.providers.sse.*;
import org.jboss.resteasy.resteasy_jaxrs.i18n.LogMessages;
import org.jboss.resteasy.resteasy_jaxrs.i18n.Messages;
import org.jboss.resteasy.util.MediaTypeHelper;

public class MySseEventInputImpl implements EventInput, Closeable {
    ...
    public MySseEventInputImpl(final Annotation[] annotations, final MediaType streamType, final MediaType elementType,
    ...
    public InboundSseEvent read() throws IOException {
        ...
        try {
            ...
            if (chunk == null) {
                System.out.println("Gonna close because chunk is null");
                close();
                return null;
            }
            ...
            try {
                e1.printStackTrace();
                System.out.println("Gonna close because IO Exception: " + e1);
                close();
